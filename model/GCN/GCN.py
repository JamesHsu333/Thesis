...
class GCN_3(nn.Module):
    def __init__(self, backbone='resnet', output_stride=16, num_classes=21,
        ...
        self.gcn = build_GCN(512, num_classes, k=15)
        self.br = build_br(num_classes, BatchNorm)
...
class GCN_2(nn.Module):
    def __init__(self, backbone='resnet', output_stride=16, num_classes=21,
        ...
        self.gcn = build_GCN(256, num_classes, k=15)
        self.br = build_br(num_classes, BatchNorm)
...
class GCN_1(nn.Module):
    def __init__(self, backbone='resnet', output_stride=16, num_classes=21,
        ...
        self.gcn = build_GCN(64, num_classes, k=15)
        self.br = build_br(num_classes, BatchNorm)
...
class GCN_res(nn.Module):
    def __init__(self, backbone='resnet', output_stride=16, num_classes=21,
        ...
        self.gcn1 = build_GCN(64, num_classes, k=15)
        self.gcn2 = build_GCN(256, num_classes, k=15)
        self.gcn3 = build_GCN(512, num_classes, k=15)
        self.gcn4 = build_GCN(1024, num_classes, k=15)
        ...
        self.classifier = nn.Sequential(nn.Conv2d(84, num_classes, 1), 
    ...
    def forward(self,x):
        ...
        gc_fm1 = self.classifier(gc_fm1)
        gc_fm_out = gc_fm1
        out = F.interpolate(gc_fm1, x.size()[2:], mode='bilinear', align_corners=True)
